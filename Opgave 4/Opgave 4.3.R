...
Return <- read_excel("~/Library/CloudStorage/OneDrive-KøbenhavnsUniversitet/Uni/6. År/PFO2025/Opgave 4/Weekly_returns_4.3.xlsx", col_types = c("date", "numeric", "numeric", "numeric")) %>%
