...
$GDXIN Data_4.3.gdx
$LOAD x_min_sd x_max_ret
$GDXIN

display x_min_sd, x_max_ret
...
CumReturn_min_sd(t) = sum(i, CumReturn(t,i) * x_min_sd(i));
CumReturn_max_ret(t) = sum(i, CumReturn(t,i) * x_max_ret(i));

display CumReturn_min_sd, CumReturn_max_ret;

TotalReturn_min_sd = sum(i,TotalReturn(i)*x_min_sd(i));
TotalReturn_max_ret = sum(i,TotalReturn(i)*x_max_ret(i));

display TotalReturn_min_sd,TotalReturn_max_ret
...
FILE CumReturnFile /"CumReturn.csv"/;
...
* Write header
PUT "Date","CumReturn_min_sd","CumReturn_max_ret" /;

* Loop over dates
LOOP(t$(Last6YDates(t)),
    PUT t.tl:12:0, CumReturn_min_sd(t):12:6, CumReturn_max_ret(t):12:6/;
);
...
Return_min_sd(t) = sum(i, (1+Return(t,i)$(Last6YDates(t))) * x_min_sd(i));
Return_max_ret(t) = sum(i, (1+Return(t,i)$(Last6YDates(t))) * x_max_ret(i));

display Return_min_sd, Return_max_ret;

***** EXPORTER *******

*--- Export CumReturn to CSV ---
FILE ReturnFile /"Return_4.3.csv"/;
...
* Write header
PUT "Date","Return_min_sd","Return_max_ret" /;
