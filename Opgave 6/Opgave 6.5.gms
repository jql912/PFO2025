...
*Load weights
parameters
    x_min_cvar(AssetName)
    x_max_ret(AssetName)
;

$GDXIN Data_6.5.gdx
$LOAD x_min_cvar x_max_ret
$GDXIN

display x_min_cvar, x_max_ret
...
PARAMETERS
    CumReturn(t,i)
    CumReturn_min_cvar(t)
    CumReturn_max_ret(t)
    TotalReturn_min_cvar
    TotalReturn_max_ret
;
...
CumReturn_min_cvar(t) = sum(i, CumReturn(t,i) * x_min_cvar(i));
CumReturn_max_ret(t) = sum(i, CumReturn(t,i) * x_max_ret(i));

display CumReturn_min_cvar, CumReturn_max_ret;

TotalReturn_min_cvar = sum(i,TotalReturn(i)*x_min_cvar(i));
TotalReturn_max_ret = sum(i,TotalReturn(i)*x_max_ret(i));

display TotalReturn_min_cvar,TotalReturn_max_ret
...
FILE CumReturnFile /"CumReturn_6.5.csv"/;
...
* Write header
PUT "Date","CumReturn_min_cvar","CumReturn_max_ret" /;

* Loop over dates
LOOP(t$(Last6YDates(t)),
    PUT t.tl:12:0, CumReturn_min_cvar(t):12:6, CumReturn_max_ret(t):12:6/;
);
...
Return_min_cvar(t) = sum(i, (1+Return(t,i)$(Last6YDates(t))) * x_min_cvar(i));
Return_max_ret(t) = sum(i, (1+Return(t,i)$(Last6YDates(t))) * x_max_ret(i));

display Return_min_cvar, Return_max_ret;

***** EXPORTER *******

*--- Export CumReturn to CSV ---
FILE ReturnFile /"Return_6.5.csv"/;
...
* Write header
PUT "Date","Return_min_cvar","Return_max_ret" /;
